...
class SpriteBakeInfo {
  ...
  static Future<SpriteBakeInfo> analyze({
    ...
    try {
      ...
      final ui.Rect scanSrc = sourceRegion?.toRect() ?? sprite.src;
      final double origW = sourceRegion?.originalWidth ?? sprite.originalSize.x;
      final double origH =
          sourceRegion?.originalHeight ?? sprite.originalSize.y;
